...
- (id) parseData:(NSData *)data ofDocument:(NSString*) documentName {
    ...
    self.outcomeAttributes = [NSArray arrayWithObjects:@"xmlns",@"origin",@"name",@"action",@"dialog",@"displayMode",@"persist",@"transferDocument",@"preCondition",@"noBackgroundProcessing",nil];
